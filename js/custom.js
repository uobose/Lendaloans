    ...
    if (typeof SelectedAmount === "number") {
      ...
      switch (true) {
        case LoanAmount >= 13e4:
          RateOfInterestAmount = 0.9;
          break;
        case LoanAmount >= 115e3:
          RateOfInterestAmount = 1.1;
          break;
        case LoanAmount >= 1e5:
          RateOfInterestAmount = 1.3;
          break;
        case LoanAmount >= 8e4:
          RateOfInterestAmount = 1.5;
          break;
        case LoanAmount >= 65e3:
          RateOfInterestAmount = 1.7;
          break;
        case LoanAmount >= 5e4:
          RateOfInterestAmount = 1.8;
          break;
        case LoanAmount >= 25e3:
          RateOfInterestAmount = 1.95;
          break;
        case LoanAmount >= 1e4:
          RateOfInterestAmount = 2;
          break;
        default:
          RateOfInterestAmount = 2.09;
      }
    }
